 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var _a="FirebaseError",ya=function(t){k(e,t);function e(n,r,i){var o=t.call(this,r)||this;return o.code=n,o.customData=i,o.name=_a,Object.setPrototypeOf(o,e.prototype),Error.captureStackTrace&&Error.captureStackTrace(o,Qn.prototype.create),o}return e}(Error),Qn=function(){function t(e,n,r){this.service=e,this.serviceName=n,this.errors=r}return t.prototype.create=function(e){for(var n=[],r=1;r<arguments.length;r++)n[r-1]=arguments[r];var i=n[0]||{},o=this.service+"/"+e,a=this.errors[e],s=a?ga(a,i):"Error",u=this.serviceName+": "+s+" ("+o+").",l=new ya(o,u,i);return l},t}();function ga(t,e){return t.replace(ma,function(n,r){var i=e[r];return i!=null?String(i):"<"+r+"?>"})}var ma=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xa(t){var e={},n=new Map,r={__esModule:!0,initializeApp:a,app:o,registerVersion:l,setLogLevel:xa,onLog:f,apps:null,SDK_VERSION:Ka,INTERNAL:{registerComponent:u,removeApp:i,components:n,useAsService:c}};r.default=r,Object.defineProperty(r,"apps",{get:s});function i(h){delete e[h]}function o(h){if(h=h||At,!j(e,h))throw We.create("no-app",{appName:h});return e[h]}o.App=t;function a(h,d){if(d===void 0&&(d={}),typeof d!="object"||d===null){var p=d;d={name:p}}var y=d;y.name===void 0&&(y.name=At);var _=y.name;if(typeof _!="string"||!_)throw We.create("bad-app-name",{appName:String(_)});if(j(e,_))throw We.create("duplicate-app",{appName:_});var g=new t(h,y,r);return e[_]=g,g}function s(){return Object.keys(e).map(function(h){return e[h]})}function u(h){var d=h.name;if(n.has(d))return Ue.debug("There were multiple attempts to register component "+d+"."),h.type==="PUBLIC"?r[d]:null;if(n.set(d,h),h.type==="PUBLIC"){var p=function(I){if(I===void 0&&(I=o()),typeof I[d]!="function")throw We.create("invalid-app-argument",{appName:d});return I[d]()};h.serviceProps!==void 0&&st(p,h.serviceProps),r[d]=p,t.prototype[d]=function(){for(var I=[],x=0;x<arguments.length;x++)I[x]=arguments[x];var Me=this._getService.bind(this,d);return Me.apply(this,h.multipleInstances?I:[])}}for(var y=0,_=Object.keys(e);y<_.length;y++){var g=_[y];e[g]._addComponent(h)}return h.type==="PUBLIC"?r[d]:null}function l(h,d,p){var y,_=(y=qa[h])!==null&&y!==void 0?y:h;p&&(_+="-"+p);var g=_.match(/\s|\//),I=d.match(/\s|\//);if(g||I){var x=['Unable to register library "'+_+'" with version "'+d+'":'];g&&x.push('library name "'+_+'" contains illegal characters (whitespace or "/")'),g&&I&&x.push("and"),I&&x.push('version name "'+d+'" contains illegal characters (whitespace or "/")'),Ue.warn(x.join(" "));return}u(new pt(_+"-version",function(){return{library:_,version:d}},"VERSION"))}function f(h,d){if(h!==null&&typeof h!="function")throw We.create("invalid-log-argument");Da(h,d)}function c(h,d){if(d==="serverAuth")return null;var p=d;return p}return r}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var $n="5",Hi="v",Qi="s",Gi="r",ji="f",zi=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,Yi="ls",ys="p",Sn="ac",$i="websocket",qi="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var su=Math.log(2),uu=function(){function t(e){var n=function(o){return parseInt(Math.log(o)/su,10)},r=function(o){return parseInt(Array(o+1).join("1"),2)};this.count=n(e+1),this.current_=this.count-1;var i=r(this.count);this.bits_=e+1&i}return t.prototype.nextBitIsOne=function(){var e=!(this.bits_&1<<this.current_);return this.current_--,e},t}(),kt=function(t,e,n,r){t.sort(e);var i=function(u,l){var f=l-u,c,h;if(f===0)return null;if(f===1)return c=t[u],h=n?n(c):c,new ee(h,c.node,ee.BLACK,null,null);var d=parseInt(f/2,10)+u,p=i(u,d),y=i(d+1,l);return c=t[d],h=n?n(c):c,new ee(h,c.node,ee.BLACK,p,y)},o=function(u){for(var l=null,f=null,c=t.length,h=function(g,I){var x=c-g,Me=c;c-=g;var fn=i(x+1,Me),cn=t[x],sa=n?n(cn):cn;d(new ee(sa,cn.node,I,null,fn))},d=function(g){l?(l.left=g,l=g):(f=g,l=g)},p=0;p<u.count;++p){var y=u.nextBitIsOne(),_=Math.pow(2,u.count-(p+1));y?h(_,ee.BLACK):(h(_,ee.BLACK),h(_,ee.RED))}return f},a=new uu(t.length),s=o(a);return new ue(r||e,s)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var go=function(){function t(e){this.collection_=e,this.last_=null}return t.prototype.get=function(){var e=this.collection_.get(),n=ve({},e);return this.last_&&L(this.last_,function(r,i){n[r]=n[r]-i}),this.last_=e,n},t}();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $t(t,e){return{eventCache:t,serverCache:e}}function rt(t,e,n,r){return $t(new ge(e,n,r),t.serverCache)}function Eo(t,e,n,r){return $t(t.eventCache,new ge(e,n,r))}function Lt(t){return t.eventCache.isFullyInitialized()?t.eventCache.getNode():null}function Oe(t){return t.serverCache.isFullyInitialized()?t.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var hc=Ae;Ae.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};Ae.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};var dc=no,pc=function(t){var e=Ae.prototype.put;return Ae.prototype.put=function(n,r,i,o){o!==void 0&&(o=t()),e.call(this,n,r,i,o)},function(){Ae.prototype.put=e}},vc=qn,_c=function(t){return t._delegate._queryIdentifier},yc=function(t){Gf(t)},gc=Object.freeze({__proto__:null,DataConnection:hc,RealTimeConnection:dc,hijackHash:pc,ConnectionTarget:vc,queryIdentifier:_c,forceRestClient:yc});/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
